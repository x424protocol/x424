...
Snapshot: 2026-08-28. This page summarizes public evidence; the authoritative
...
| TypeScript SDK              | Published npm developer preview      | [Provenance-backed `x424@0.1.5`](program/RELEASE_0.1.5.md), package and conformance tests |
...
| Self-hosted verifier        | Published signed evaluation profile  | [Pinned 0.1.5 image and attestations](program/RELEASE_0.1.5.md), Compose, Redis, Helm     |
