...
| 0.1 package              | complete           | [signed `v0.1.3`, npm provenance, tarball/checksum, image](RELEASE_0.1.3.md)  | —                                                                 |
...
| 0.2 self-hosted verifier | partial            | [0.1.3 signed image, SBOM/provenance](RELEASE_0.1.3.md), Helm, key interfaces | independent assessment and production load/failover exercises     |
